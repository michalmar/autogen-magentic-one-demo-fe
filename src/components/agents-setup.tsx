  ...
  return (
    ...
    <div className="grid auto-rows-min gap-4 md:grid-cols-5">
      {agents.map((agent) => (
        ...
        <div key={agent.input_key} className=" rounded-xl bg-muted/50 shadow p-4">
          ...
          {/* <div className="w-full right-2 top-2 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 "> */}
          ...
          <DialogContent className="sm:max-w-[625px] sm:max-h-[80%]">
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                This structure is default when you ingest and vectorize document directly from Azure AI Search.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  id="index_name"
                  className="col-span-3"
                  defaultValue="vector-autogen-rag"
